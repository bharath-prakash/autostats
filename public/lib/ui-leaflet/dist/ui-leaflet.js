    ...
    return {
        ...
        createMarker: function createMarker(markerData) {
            ...
            var markerOptions = {
                ...
                rotationAngle: isDefined(markerData.iconAngle) ? markerData.iconAngle : 0
            };
            ...
            /*if(isDefined(markerData.mvcoords)){
                var mvMarker = new L.Marker.movingMarker(markerData.mvcoords,[2000]).addTo(map);
                mvMarker.start();
            }*/
